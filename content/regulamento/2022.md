...
<ul>
    <li> Estimular a produção e o uso de dados abertos sobre temas de interesse público no jornalismo;
    <li> Incentivar práticas de transparência ativa a respeito da metodologia e fontes de dados utilizadas em trabalhos jornalísticos;
    <li> Inspirar estudantes e jornalistas a trabalharem com dados em suas investigações;
    <li> Reconhecer profissionais e trabalhos de destaque no campo do jornalismo de dados;
</ul>
